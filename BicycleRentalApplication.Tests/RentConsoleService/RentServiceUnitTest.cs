...
namespace BicycleRentalApplication.Tests.RentConsoleService
{
    ...
    {
        private Mock<RentService> consoleServiceMocker;
        ...
        {
            consoleServiceMocker = new Mock<RentService>() { CallBase = true };
        ...
        private RentService GetSut()
        {
            RentService sut = consoleServiceMocker.Object;
